...
namespace NitroTechWebsite
{
    public partial class DownloadInvoice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            GenerateInvoice(quotationNumber, invoiceNumber);
        }
        ...
        private void GenerateInvoice(string quotationNumber, string invoiceNumber)
        {
            try
            {
    ...
    WHERE q.quotationNumber = @QNum", conn))
                ...
                makeInvoice(products, clientName, clientAddress, clientEmail, clientPhone, vehicleVIN, vehicleName, invoiceNumber, labourFeeStr, totalStr);
            }
            catch (Exception ex)
            {
