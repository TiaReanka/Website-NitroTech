<%@ Page Title="Update Customers" Language="C#" MasterPageFile="~/Site.Master"   
    AutoEventWireup="true" CodeBehind="CustomerUpdate.aspx.cs"  
Inherits="NitroTechWebsite.Customers" %>  
...
runat="server">  
    <style>  
        ...
        .form-container button, .form-container input[type="submit"], .form-container  
input[type="button"], .form-container .aspNetButton {  
            display: block;  
            max-width: 600px;  
            margin: 20px auto;  
            padding: 12px;  
        ...
        .form-container input[type="button"]:hover, .form-container .aspNetButton:hover {  
            ...
            color: #fff;  
            border-radius: 5px;  
            box-shadow: 0 0 5px #3c00a0, 0 0 25px #3c00a0, 0 0 50px #3c00a0, 0 0 100px  
#3c00a0;  
        }  
    ...
    <div class="form-container">  
        ...
        <div class="form-row">  
            ...
            <div class="form-group">  
                <label for="ddlVIN">VIN:</label>  
                <asp:DropDownList ID="ddlVIN" runat="server" Enabled="false">  
                </asp:DropDownList>  
            </div>  
        </div>  
...
CssClass="aspNetButton"/>  
        ...
        <asp:Button ID="btnSave" runat="server" Text="Save Customer & Vehicle"  
OnClick="btnSave_Click" CssClass="aspNetButton"/>  
    </div>  
</asp:Content>