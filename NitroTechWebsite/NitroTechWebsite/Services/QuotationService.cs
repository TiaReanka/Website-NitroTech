...
namespace NitroTechWebsite.Services
{
    ...
    {
        public PdfDocument GetQuotation(string[,] products, string clientName, string clientAddress, string clientEmail, string clientPhone, string vehicleVIN, string vehicleName, string quotationNumber, string labourFee, string productTotal)
        {
            ...
            BuildDocument(document, products, clientName, clientAddress, clientEmail, clientPhone, vehicleVIN, vehicleName, quotationNumber, labourFee, addedTotal);
        ...
        private void BuildDocument(Document document, string[,] products, string clientName, string clientAddress, string clientEmail, string clientPhone, string vehicleVIN, string vehicleName, string quotationNumber, string labourFee, string addedTotal)
        {
            ...
            paragraph.AddFormattedText("QUOTATION", TextFormat.Bold);
            paragraph.Format.Font.Size = 20;
            paragraph.Format.Alignment = ParagraphAlignment.Center;

            //Client's Details
            paragraph = section.AddParagraph();
            paragraph.AddFormattedText("QUOTED TO\n", TextFormat.Bold);
            ...
            paragraph.AddFormattedText("Quotation no: ", TextFormat.Bold);
            paragraph.AddText(quotationNumber); // Custom invoice number
            paragraph.AddLineBreak();
            ...
            paragraph.AddText("Please note: This quotation is valid for a period of 30 days from the date of issue. Prices and availability of parts, services, labour and repairs are subject to change beyond this period.");
